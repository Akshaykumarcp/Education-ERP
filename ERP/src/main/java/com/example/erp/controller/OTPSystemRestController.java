...
import com.example.erp.model.OTPSystem;
...
public class OTPSystemRestController {
	 ...
	 private static final String ACCOUNT_SID = "AC553d69e0a5e3d34dd5cc8db1f0ff47d0";
	...
	public ResponseEntity<Object> sendOTP(@PathVariable("mobilenumber") String mobile)
	{
		
		OTPSystem otpsystem= new OTPSystem();
		otpsystem.setMobileNumber("mobile");
		otpsystem.setOtp(String.valueOf(((int)(Math.random()*(10000-1000)))+1000));
		otpsystem.setExpirytime(System.currentTimeMillis()+20000);
		otp_data.put("mobile", otpsystem);
		Message.creator(new PhoneNumber("mobile"),
                new PhoneNumber("+12052368290"),
                "Your OTP is"+otpsystem.getOtp()).create();
		/*Message message = Message.creator(new PhoneNumber("+918123920743"), new PhoneNumber("+12052368290"),"Your OTP is"+otpsystem.getOtp()).create();*/
	...
	public ResponseEntity<Object> verifyOTP(@PathVariable("mobilenumber") String mobilenumber, @RequestBody OTPSystem requestBodyOTP)
	{
