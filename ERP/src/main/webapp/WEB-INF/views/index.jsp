...
<div class="container">
  ...
  <div class="form-group">
   ...
   <form:input type="text" class="form-control" path="fullname" name="personName" minlength="5" placeholder="Enter Full Name*" id="name" />
 ...
 <%-- <form:errors path="phonenumber" cssClass="error"/>	 --%>			
  ...
  <div class="form-group">
  <!-- style="width: 180px" -->
  <form:select  path="" name="prgm" class="form-control" id="programtype" >
...
$.validator.addMethod("valueNot", function(value, element, arg){
	  return arg !== value;
	 }, "Value must not equal arg.");
