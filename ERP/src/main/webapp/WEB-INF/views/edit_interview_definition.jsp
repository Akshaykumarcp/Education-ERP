...
<body>
 ...
 <form:form  method="POST" modelAttribute="interviewdef" action="/save-interview-definition">
 
 
  <div class="card">
          <div class="card-header">Edit Interview Definition</div>
 <br/>
 ...
 <!-- first row -->
  <div class="form-row">
    ...
    <%-- <h1>${programs.programname}</h1> --%>
      ...
      <%-- value = "${program.id}"  --%>    
      	 <option label="Select"> ${program.programname} </option>
      </c:forEach>
